...
const Smashblade = () => {
  const project = {
    ...
    galleryImages: ["/images/smashblade-one.png", "/images/smashblade-two.png"],
    ...
    <div className="relative bg-neutral-900 min-h-screen z-10">
      ...
      <div className="relative z-20 text-white left-1/2 -translate-x-1/2 max-w-4xl px-4 md:px-0 py-8">
        <div className="flex items-center gap-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">SMASHBLADE </h2>
          <p className="text-xs bg-purple-400 p-1 rounded-md mb-4 font-bold">
            IN DEVELOPMENT
          </p>
          <p className="text-xs bg-red-400 p-1 rounded-md mb-4 font-bold">
            NOT RELEASED
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row py-4 gap-8">
          ...
          <div className="md:w-[85%]">
            This project is a multi-application stack, serving as a website,
            gameserver and api. It handles a competitve gaming network and its
            players, saving and displaying their statistics.
          </div>
        </div>
